...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const fetchPatientsAndDoctors = async () => {
      try {
        const patientsResponse = await axios.get('http://localhost:8080/home/patients'); // Replace with your actual endpoint
  ...
  const handleDelete = async (patientId) => {
    try {
      await axios.delete(`http://localhost:8080/home/patients/${patientId}`);
